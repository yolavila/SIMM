...
<table width="100%">
  ...
  <?php
		...
		{
			$query = "Select * from applicant where status='1' and tanggal between '$tanggal' AND '$tanggal1'";
		}
		...
		{
		$query = "SELECT applicant.*, hired.*, terminate.* from applicant INNER JOIN hired on applicant.no_applicant=hired.no_applicant INNER JOIN terminate on applicant.no_applicant=terminate.no_applicant where status='8' and tgl_terminate as tanggal between '$tanggal' AND '$tanggal1'";
		}
