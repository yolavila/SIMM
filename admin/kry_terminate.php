...
<table width="100%">
  ...
  <?php
		$query = "SELECT applicant.*, hired.*, terminate.* from applicant INNER JOIN hired on applicant.no_applicant=hired.no_applicant LEFT JOIN terminate on applicant.no_applicant = terminate.no_applicant where 1";
		if($searchOptions == "no")
		{
